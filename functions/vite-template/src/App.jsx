...
// ※ 푸터(Footer) 컴포넌트는 파일이 없으므로 가져오지 않습니다.

// =================================================================
// 2. data.json의 이름과 실제 컴포넌트를 연결합니다.
// =================================================================
const componentMap = {
  // 헤더
  "헤더02": TpHeader02,
...
function App() {
  ...
  // 3. 이름에 맞는 헤더/푸터 컴포넌트를 찾습니다.
  const HeaderComponent = componentMap[headerName];
  const FooterComponent = componentMap[footerName];
